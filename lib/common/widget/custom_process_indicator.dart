...
class _CustomRefreshProgressIndicatorPainter
    extends _CircularProgressIndicatorPainter {
  _CustomRefreshProgressIndicatorPainter({
...
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicator]
///    when the underlying vertical scrollable is overscrolled.
class CustomRefreshProgressIndicator extends CircularProgressIndicator {
...
class _CustomRefreshProgressIndicatorState
    extends _CircularProgressIndicatorState {
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: Padding(
            ...
            child: CustomPaint(
              painter: _CustomRefreshProgressIndicatorPainter(
                valueColor: widget._getValueColor(context),
