...
class _MarqueeState extends State<Marquee> with SingleTickerProviderStateMixin {
  ...
  void _initialize(BuildContext context) {
    ...
    final totalLength = _textWidth + widget.blankSpace;
  ...
  Widget build(BuildContext context) {
    ...
    Widget marquee = ListView.builder(
      ...
      itemBuilder: (_, i) {
        final text = i.isEven ? content : _buildBlankSpace();
    ...
    return kIsWeb
        ? marquee
        : widget.ancestorWidth != null && widget.ancestorWidth! > _textWidth
            ? content
            : _wrapWithFadingEdgeScrollView(marquee);
  }
