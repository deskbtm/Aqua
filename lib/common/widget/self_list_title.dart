...
/// Defines the title font used for [SelfListTile] descendants of a [ListTileTheme].
///
...
enum ListTileStyle {
  /// Use a title font that's appropriate for a [SelfListTile] in a list.
  list,

  /// Use a title font that's appropriate for a [SelfListTile] that appears in a [Drawer].
  drawer,
}

/// An inherited widget that defines color and style parameters for [SelfListTile]s
/// in this widget's subtree.
///
/// Values specified here are used for [SelfListTile] properties that are not given
...
class ListTileTheme extends InheritedTheme {
  ...
  /// Creates a list tile theme that controls the color and style parameters for
  /// [SelfListTile]s, and merges in the current list tile theme, if any.
  ///
  ...
  /// If true then [SelfListTile]s will have the vertically dense layout.
  final bool dense;

  /// If specified, [shape] defines the shape of the [SelfListTile]'s [InkWell] border.
  final ShapeBorder shape;

  /// If specified, [style] defines the font used for [SelfListTile] titles.
  final ListTileStyle style;

  /// If specified, the color used for icons and text when a [SelfListTile] is selected.
  final Color selectedColor;

  /// If specified, the icon color used for enabled [SelfListTile]s that are not selected.
  final Color iconColor;

  /// If specified, the text color used for enabled [SelfListTile]s that are not selected.
  final Color textColor;

  /// The tile's internal padding.
  ///
  /// Insets a [SelfListTile]'s contents: its [SelfListTile.leading], [SelfListTile.title],
  /// [SelfListTile.subtitle], and [SelfListTile.trailing] widgets.
  final EdgeInsetsGeometry contentPadding;

  /// If specified, defines the background color for `SelfListTile` when
  /// [SelfListTile.selected] is false.
  ///
  /// If [SelfListTile.tileColor] is provided, [tileColor] is ignored.
  final Color tileColor;

  /// If specified, defines the background color for `SelfListTile` when
  /// [SelfListTile.selected] is true.
  ///
  /// If [SelfListTile.selectedTileColor] is provided, [selectedTileColor] is ignored.
...
/// Where to place the control in widgets that use [SelfListTile] to position a
/// control next to a label.
///
/// See also:
///
///  * [CheckboxListTile], which combines a [SelfListTile] with a [Checkbox].
///  * [RadioListTile], which combines a [SelfListTile] with a [Radio] button.
///  * [SwitchListTile], which combines a [SelfListTile] with a [Switch].
...
/// [SelfListTile]s in [Card]s.
///
/// ![Different variations of SelfListTile](https://flutter.github.io/assets-for-api-docs/assets/material/list_tile.png)
///
/// ```dart
/// ListView(
///   children: const <Widget>[
///     Card(child: SelfListTile(title: Text('One-line SelfListTile'))),
///     Card(
///       child: SelfListTile(
///         leading: FlutterLogo(),
...
///     Card(
///       child: SelfListTile(
///         title: Text('One-line dense SelfListTile'),
///         dense: true,
///       ),
///     ),
///     Card(
...
///         title: Text('Two-line SelfListTile'),
...
///         title: Text('Three-line SelfListTile'),
///         subtitle: Text(
...
///
/// For this reason, a one-line SelfListTile allows the height of [leading]
/// and [trailing] widgets to be constrained by the height of the SelfListTile.
...
/// {@tool snippet}
///
/// Here is an example of a one-line, non-[dense] SelfListTile with a
...
/// SelfListTile, adjust the vertical padding to 8.0.
///
/// ```dart
/// SelfListTile(
...
/// {@end-tool}
///
/// ## The SelfListTile layout isn't exactly what I want
///
/// If the way SelfListTile pads and positions its elements isn't quite what
...
/// See also:
///
///  * [ListTileTheme], which defines visual properties for [SelfListTile]s.
///  * [ListView], which can display an arbitrary number of [SelfListTile]s
///    in a scrolling list.
///  * [CircleAvatar], which shows an icon representing a person and is often
///    used as the [leading] element of a SelfListTile.
///  * [Card], which can be used with [Column] to show a few [SelfListTile]s.
///  * [Divider], which can be used to separate [SelfListTile]s.
///  * [SelfListTile.divideTiles], a utility for inserting [Divider]s in between [SelfListTile]s.
///  * [CheckboxListTile], [RadioListTile], and [SwitchListTile], widgets
///    that combine [SelfListTile] with other controls.
...
class SelfListTile extends StatelessWidget {
  /// Creates a list tile.
  ///
  ...
  /// The tile's internal padding.
  ///
  /// Insets a [SelfListTile]'s contents: its [leading], [title], [subtitle],
  ...
  /// Defines the background color of `SelfListTile` when [selected] is false.
  ///
  /// When the value is null, the `tileColor` is set to [ListTileTheme.tileColor]
  /// if it's not null and to [Colors.transparent] if it's null.
  final Color tileColor;

  /// Defines the background color of `SelfListTile` when [selected] is true.
  ///
...
class _RenderListTile extends RenderBox {
  ...
  void performLayout() {
    ...
    assert(
        ...
        'or consider replacing SelfListTile with a custom widget '
        '(see https://api.flutter.dev/flutter/material/SelfListTile-class.html#material.SelfListTile.4)');
    assert(
