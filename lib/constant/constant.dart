...
const String BAK_EXTERNAL_PATH = '/storage/emulated/0';
...
const DEV_CODE_SERVER_URL = 'http://192.168.0.104:8080';
const CODE_SERVER_PWD = 'code-server-pwd';
const DEF_AMOUNT = '6';
const DEF_BASE_URL = 'https://dark-flame-bricker.icu:1031';

const LOGIN_TOKEN = 'login-token';
const LOGIN_USERNMAE = 'login-username';
