...
abstract class BackButtonInterceptor implements WidgetsBinding {
  ...
  static Function handlePopRouteFunction =
      WidgetsBinding.instance.handlePopRoute;

  static Function handlePushRouteFunction =
    ...
    for (var i = 0; i < interceptors.length; i++) {
      ...
      try {
        ...
        if (!interceptor.ifNotYetIntercepted || !stopDefaultButtonEvent) {
          result = await interceptor.interceptionFunction(
  ...
  static Future<void> _pushRoute(dynamic arguments) =>
      handlePushRouteFunction(arguments);
...
typedef InterceptorFunction = Future<bool> Function(
