 ...
 */
public class StorageMountListenerPlugin extends BroadcastReceiver implements FlutterPlugin, EventChannel.StreamHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    eventChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "storage_mount_listener");
  ...
  public void onListen(Object arguments, final EventChannel.EventSink events) {
    sdcardStatusReceiver = new BroadcastReceiver() {
      ...
      public void onReceive(Context context, Intent intent) {
        Log.i("StorageMount", intent.getAction());
